...
import { GridChartPreview } from "./components/GridChartPreview";
...
export function App() {
  ...
  const [generatedPreview, setGeneratedPreview] = useState<ShadowProposal | null>(null);
